...
_lr_productions = [
  ...
  ('program -> statement_list','program',1,'p_program','grammar_rules.py',10),
  ('statement_list -> statement_list statement','statement_list',2,'p_statement_list','grammar_rules.py',14),
  ('statement_list -> statement','statement_list',1,'p_statement_list','grammar_rules.py',15),
  ('statement_list_opt -> statement_list','statement_list_opt',1,'p_statement_list_opt','grammar_rules.py',22),
  ('statement_list_opt -> empty','statement_list_opt',1,'p_statement_list_opt','grammar_rules.py',23),
  ('statement -> declaration_stmt','statement',1,'p_statement','grammar_rules.py',30),
  ('statement -> assignment_stmt','statement',1,'p_statement','grammar_rules.py',31),
  ('statement -> function_def_stmt','statement',1,'p_statement','grammar_rules.py',32),
  ('statement -> function_call_stmt','statement',1,'p_statement','grammar_rules.py',33),
  ('statement -> if_stmt','statement',1,'p_statement','grammar_rules.py',34),
  ('statement -> while_stmt','statement',1,'p_statement','grammar_rules.py',35),
  ('statement -> return_stmt','statement',1,'p_statement','grammar_rules.py',36),
  ('declaration_stmt -> type_specifier IDENTIFIER EQUALS expression EOL','declaration_stmt',5,'p_declaration_stmt','grammar_rules.py',43),
  ('type_specifier -> INT_TYPE','type_specifier',1,'p_type_specifier','grammar_rules.py',51),
  ('type_specifier -> FLOAT_TYPE','type_specifier',1,'p_type_specifier','grammar_rules.py',52),
  ('type_specifier -> STRING_TYPE','type_specifier',1,'p_type_specifier','grammar_rules.py',53),
  ('type_specifier -> BOOL_TYPE','type_specifier',1,'p_type_specifier','grammar_rules.py',54),
  ('type_specifier -> DATE_TYPE','type_specifier',1,'p_type_specifier','grammar_rules.py',55),
  ('type_specifier -> TIME_TYPE','type_specifier',1,'p_type_specifier','grammar_rules.py',56),
  ('type_specifier -> VOID','type_specifier',1,'p_type_specifier','grammar_rules.py',57),
  ('assignment_stmt -> IDENTIFIER EQUALS expression EOL','assignment_stmt',4,'p_assignment_stmt','grammar_rules.py',64),
  ('function_def_stmt -> FUNCTION type_specifier IDENTIFIER LPAREN param_list RPAREN block_stmt','function_def_stmt',7,'p_function_def_stmt','grammar_rules.py',74),
  ('param_list -> param_list COMMA param','param_list',3,'p_param_list','grammar_rules.py',83),
  ('param_list -> param','param_list',1,'p_param_list','grammar_rules.py',84),
  ('param_list -> empty','param_list',1,'p_param_list','grammar_rules.py',85),
  ('param -> type_specifier IDENTIFIER','param',2,'p_param','grammar_rules.py',94),
  ('block_stmt -> LBRACKET statement_list_opt RBRACKET','block_stmt',3,'p_block_stmt','grammar_rules.py',104),
  ('callable -> IDENTIFIER','callable',1,'p_callable','grammar_rules.py',111),
  ('callable -> BOOK','callable',1,'p_callable','grammar_rules.py',112),
  ('callable -> GEN','callable',1,'p_callable','grammar_rules.py',113),
  ('callable -> REG','callable',1,'p_callable','grammar_rules.py',114),
  ('callable -> DISPLAY','callable',1,'p_callable','grammar_rules.py',115),
  ('function_call_stmt -> function_call EOL','function_call_stmt',2,'p_function_call_stmt','grammar_rules.py',119),
  ('function_call -> callable LPAREN arg_list RPAREN','function_call',4,'p_function_call','grammar_rules.py',123),
  ('arg_list -> arg_list COMMA expression','arg_list',3,'p_arg_list','grammar_rules.py',130),
  ('arg_list -> expression','arg_list',1,'p_arg_list','grammar_rules.py',131),
  ('arg_list -> empty','arg_list',1,'p_arg_list','grammar_rules.py',132),
  ('if_stmt -> IF LPAREN expression RPAREN block_stmt','if_stmt',5,'p_if_stmt','grammar_rules.py',144),
  ('if_stmt -> IF LPAREN expression RPAREN block_stmt ELSE block_stmt','if_stmt',7,'p_if_stmt','grammar_rules.py',145),
  ('while_stmt -> WHILE LPAREN expression RPAREN block_stmt','while_stmt',5,'p_while_stmt','grammar_rules.py',159),
  ('return_stmt -> RETURN expression EOL','return_stmt',3,'p_return_stmt','grammar_rules.py',166),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','grammar_rules.py',175),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','grammar_rules.py',176),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','grammar_rules.py',177),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','grammar_rules.py',178),
  ('expression -> expression LE expression','expression',3,'p_expression_binop','grammar_rules.py',179),
  ('expression -> expression GE expression','expression',3,'p_expression_binop','grammar_rules.py',180),
  ('expression -> expression LT expression','expression',3,'p_expression_binop','grammar_rules.py',181),
  ('expression -> expression GT expression','expression',3,'p_expression_binop','grammar_rules.py',182),
  ('expression -> expression EQ expression','expression',3,'p_expression_binop','grammar_rules.py',183),
  ('expression -> expression NEQ expression','expression',3,'p_expression_binop','grammar_rules.py',184),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_paren','grammar_rules.py',192),
  ('expression -> NUMBER','expression',1,'p_expression_atom','grammar_rules.py',196),
  ('expression -> FLOAT_NUM','expression',1,'p_expression_atom','grammar_rules.py',197),
  ('expression -> STRING_LITERAL','expression',1,'p_expression_atom','grammar_rules.py',198),
  ('expression -> BOOLEAN_VAL','expression',1,'p_expression_atom','grammar_rules.py',199),
  ('expression -> DATE_VAL','expression',1,'p_expression_atom','grammar_rules.py',200),
  ('expression -> TIME_VAL','expression',1,'p_expression_atom','grammar_rules.py',201),
  ('expression -> IDENTIFIER','expression',1,'p_expression_atom','grammar_rules.py',202),
  ('expression -> function_call','expression',1,'p_expression_atom','grammar_rules.py',203),
  ('empty -> <empty>','empty',0,'p_empty','grammar_rules.py',216),
]
